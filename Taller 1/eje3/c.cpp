...
if(tdibujo>tcuadro){
    ...
    xrotado0=Planeta[0].Getx()*std::cos(omega*t)+Planeta[0].Gety()*std::sin(omega*t);
    yrotado0=-Planeta[0].Getx()*std::sin(omega*t)+Planeta[0].Gety()*std::cos(omega*t);
    xrotado1=Planeta[1].Getx()*std::cos(omega*t)+Planeta[1].Gety()*std::sin(omega*t);
    yrotado1=-Planeta[1].Getx()*std::sin(omega*t)+Planeta[1].Gety()*std::cos(omega*t);
    xrotado2=Planeta[2].Getx()*std::cos(omega*t)+Planeta[2].Gety()*std::sin(omega*t);
    yrotado2=-Planeta[2].Getx()*std::sin(omega*t)+Planeta[2].Gety()*std::cos(omega*t);
    
    // hacer un plot
    //std::cout<< Planeta[0].Getx()<<"\t"<<Planeta[0].Gety()<<"\t"<< Planeta[1].Getx()<<"\t"<<Planeta[1].Gety()<<"\t"<<Planeta[2].Getx()<<"\t"<<Planeta[2].Gety()<<endl;
    std::cout<< xrotado0 <<"\t"<<yrotado0<<"\t"<<  xrotado1  <<"\t"<< yrotado1 <<"\t"<< xrotado2 <<"\t"<< yrotado2 << endl;
